    ...
    >
      <div className="w-full max-w-sm bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-slate-800">
          <div>
            <h2 className="text-white font-black text-lg">Reset Password</h2>
            <p className="text-slate-400 text-xs mt-0.5">Enter your email and choose a new password</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5">
          ...
          {success ? (
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <p className="text-emerald-400 font-bold text-sm">Password updated successfully!</p>
              <p className="text-slate-400 text-xs">You can now sign in with your new password.</p>
              <button
                onClick={onClose}
                className="mt-2 w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold transition-colors"
              >
                Back to Sign In
              </button>
            </div>
            ...
            <>
              ...
              <form onSubmit={handleReset} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all"
                    />
                    <button
                      type="button"
                      tabIndex="-1"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 rounded-xl font-bold text-white text-sm bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-600/25 transition-all duration-200"
                >
                  {loading ? (
