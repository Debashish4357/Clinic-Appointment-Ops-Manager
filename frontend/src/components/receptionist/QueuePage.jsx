          ...
          <div className="w-full max-w-2xl max-h-[90vh] flex flex-col rounded-3xl border border-white/10 bg-slate-900 shadow-2xl overflow-hidden"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs font-medium text-slate-400 mt-1">
                    ...
                    {patientModal.blood_group && <span className="flex items-center gap-1 text-red-300">🩸 {patientModal.blood_group}</span>}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-900/50">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { label: 'Address',         val: patientModal.address,         icon: '📍' },
                  { label: 'Insurance Info',  val: patientModal.insurance_info,  icon: '🛡️' },
              ...
              {patientModal.lab_reports?.length > 0 && (
                <div>
